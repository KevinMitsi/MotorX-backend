...
class InventoryDtoTest {
    ...
    void recordsShouldExposeProperties() {
        CreateSpareDTO createSpareDTO = new CreateSpareDTO("Filtro", "AKT", "SAV-1", "REP-1", BigDecimal.TEN, false, "Prov", 3, "01-01-01-01");
        UpdateSpareDTO updateSpareDTO = new UpdateSpareDTO("Filtro2", "Yamaha", "SAV-2", "REP-2", BigDecimal.ONE, true, "Prov2", 5, "02-02-02-02");
        ...
        SpareResponseDTO spareResponseDTO = new SpareResponseDTO(1L, "Filtro", "AKT", "SAV-1", "REP-1", BigDecimal.TEN, new BigDecimal("13.5"), false, "Prov", 4, "01-01-01-01");
